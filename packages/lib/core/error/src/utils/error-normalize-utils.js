...
import { ErrorXFBDebug } from "./error-x-fb-debug";
...
function normalizeError(error) {
  ...
  const taalOpcodes =
    error.taalOpcodes !== undefined && error.taalOpcodes !== null
      ? error.taalOpcodes
      : [];
  ...
  const messageFormat =
    error.messageFormat !== null && error.messageFormat !== undefined
      ? error.messageFormat
      : error.message;

  const messageParams = (
    error.messageParams !== null && error.messageParams !== undefined
      ? error.messageParams
      : []
  ...
  const errorName =
    error.errorName !== null && error.errorName !== undefined
      ? error.errorName
      : error.name;
  ...
  let lineNumber =
    error.lineNumber !== null && error.lineNumber !== undefined
      ? error.lineNumber
      : error.line;
  let columnNumber =
    error.columnNumber !== null && error.columnNumber !== undefined
      ? error.columnNumber
      : error.column;
  let fileName =
    error.fileName !== null && error.fileName !== undefined
      ? error.fileName
      : error.sourceURL;
  ...
  const obj = {
    ...
    guardList:
      error.guardList !== null && error.guardList !== undefined
        ? error.guardList
        : [],
