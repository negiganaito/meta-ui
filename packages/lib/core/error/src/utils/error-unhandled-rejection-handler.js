...
function handleUnhandledRejection(event) {
  ...
  if (
    ...
    if (
      typeof errorReason.message !== "string" &&
      typeof errorReason.messageFormat === "string"
    ) {
    ...
    if (
      typeof errorReason.message !== "string" &&
      typeof errorReason.errorMsg === "string"
    ) {
    ...
    if (
      normalizedError !== errorReason &&
      typeof errorReason.name === "string"
    ) {
      ...
      normalizedError === errorReason && errorName
        ...
        : errorReason.name ||
          (keys.length
            ...
            : "UnhandledRejection_" +
              (errorReason ? typeof errorReason : "null"));
