...
function createErrorPayload(nError, props) {
  const obj = {
    ...
    bundle_variant:
      props.bundle_variant !== null && props.bundle_variant !== undefined
        ? props.bundle_variant
        : null,
    ...
    frontend_env:
      props.frontend_env !== null && props.frontend_env !== undefined
        ? props.frontend_env
        : undefined, //
    ...
    rollout_hash:
      props.rollout_hash !== null && props.rollout_hash !== undefined
        ? props.rollout_hash
        : null,
    ...
    additional_client_revisions: Array.from(
      props.additional_client_revisions !== null &&
        props.additional_client_revisions !== void 0
