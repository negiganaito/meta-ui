...
import { BaseNestedPressableHack_DO_NOT_USE } from '@meta-core/pressable/base-nested-pressable-hack_DO_NOT_USE';
...
export const BaseLink = forwardRef(
  ...
  (
    ...
    const ref = useMemo(() => useMergeRefs(externalRef, internalRef), [externalRef, internalRef]);
